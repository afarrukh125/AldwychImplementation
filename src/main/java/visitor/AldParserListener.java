...
public interface AldParserListener extends ParseTreeListener {
	 ...
	 * labeled alternative in {@link AldParser#mainprocedure}.
	 * @param ctx the parse tree
	 */
	void enterMainProcedureNode(AldParser.MainProcedureNodeContext ctx);
	/**
	 * Exit a parse tree produced by the {@code MainProcedureNode}
	 * labeled alternative in {@link AldParser#mainprocedure}.
	 * @param ctx the parse tree
	 */
	void exitMainProcedureNode(AldParser.MainProcedureNodeContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterStructureEqNode(AldParser.StructureEqNodeContext ctx);
	/**
	 * Exit a parse tree produced by the {@code StructureEqNode}
	 * labeled alternative in {@link AldParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitStructureEqNode(AldParser.StructureEqNodeContext ctx);
	/**
