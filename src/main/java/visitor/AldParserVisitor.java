...
public interface AldParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitMainProcedureNode(AldParser.MainProcedureNodeContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitStructureEqNode(AldParser.StructureEqNodeContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitNEqNode(AldParser.NEqNodeContext ctx);
}