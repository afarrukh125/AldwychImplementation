...
//        System.out.println("Might be a heading node");
...
//        HeadingNode headingNode = procedureNode.getHeadingNode();
//        visit(headingNode, data);
//        return super.visit(procedureNode, data);
//    }
//
//    @Override
//    public Void visit(ReaderContainerNode readerContainerNode, Object data) {
//        return super.visit(readerContainerNode, data);
//    }
//
//    @Override
